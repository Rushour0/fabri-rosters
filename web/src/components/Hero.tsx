...
export function Hero({ agencyCount, companyCount }: { agencyCount: number; companyCount: number }) {
  ...
  return (
    <section className="mx-auto max-w-content px-5 pt-20 pb-16 sm:pt-28 sm:pb-20">
      <div className="max-w-prose">
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-accent px-4 py-2.5 text-sm font-semibold text-bg transition-transform ease-fabri hover:-translate-y-0.5"
          >
            Browse the roster
